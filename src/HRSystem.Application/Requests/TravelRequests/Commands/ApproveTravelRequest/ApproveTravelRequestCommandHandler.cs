...
public class ApproveTravelRequestCommandHandler : IRequestHandler<ApproveTravelRequestCommand, TravelRequestDto>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;
    private readonly IApproverService _approverService;

    public ApproveTravelRequestCommandHandler(
    ...
    public async Task<TravelRequestDto> Handle(ApproveTravelRequestCommand request, CancellationToken cancellationToken)
    {
