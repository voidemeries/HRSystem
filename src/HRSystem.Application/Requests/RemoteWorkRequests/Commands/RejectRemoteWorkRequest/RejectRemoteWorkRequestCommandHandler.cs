...
public class RejectRemoteWorkRequestCommandHandler : IRequestHandler<RejectRemoteWorkRequestCommand, RemoteWorkRequestDto>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;
    private readonly IApproverService _approverService;

    public RejectRemoteWorkRequestCommandHandler(
    ...
    public async Task<RemoteWorkRequestDto> Handle(RejectRemoteWorkRequestCommand request, CancellationToken cancellationToken)
    {
        ...
        remoteWorkRequest.Status = RequestStatus.Rejected;
