...
public class ApproveTrainingSupportRequestCommandHandler : IRequestHandler<ApproveTrainingSupportRequestCommand, TrainingSupportRequestDto>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;
    private readonly IApproverService _approverService;

    public ApproveTrainingSupportRequestCommandHandler(
    ...
    public async Task<TrainingSupportRequestDto> Handle(ApproveTrainingSupportRequestCommand request, CancellationToken cancellationToken)
    {
        ...
        trainingRequest.Status = RequestStatus.Approved;
